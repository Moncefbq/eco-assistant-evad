...
if logo_base64:
    st.markdown(f"""
        <div style="
            ...
            margin-bottom: 15px;    /* ↓ réduit l’espace avant la ligne verte */
        ">
            <img src="data:image/png;base64,{logo_base64}" width="200" style="margin-bottom: 5px;">  <!-- ↓ réduit la distance entre logo et titre -->
